-- Surface avatar_emoji/avatar_emoji_bg through get_public_profile() for
-- both the profile itself and any managed profiles it lists, so visitor
-- pages can render an emoji avatar exactly like an uploaded photo.
